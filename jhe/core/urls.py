...
api_router.register(r'collaborators', views.CollaboratorViewSet, basename='Collaborator')
...
urlpatterns = [
    ...
    path('auth/callback_popup/', common.client_auth_callback_popup, name='client_auth_callback_popup'),
