...
from core.models import (
    ...
    Observation, Practitioner, PractitionerOrganization, PatientOrganization
)
...
class OrganizationMethodTests(TestCase):
    ...
    def test_for_patient(self):
      ...
      patient = Patient.objects.create(
        jhe_user=patient_user, identifier="PAT123",
        name_family="Johnson", name_given="John",
        birth_date="1980-01-01", telecom_phone="1234567890"
      )
...
class PatientMethodTests(TestCase):
    ...
    def test_for_practitioner_organization_study(self):
        practitioner_user = JheUser.objects.create_user(
            email="doctor@example.com", password="password", identifier="doc123",
            user_type="practitioner"
        )
    ...
    def test_count_for_practitioner_organization_study(self):
        practitioner_user = JheUser.objects.create_user(
            email="doctor2@example.com", password="password", identifier="doc456",
            user_type="practitioner"
        )
        practitioner = Practitioner.objects.get(jhe_user=practitioner_user)
    ...
    def test_practitioner_authorized(self):
        practitioner_user = JheUser.objects.create_user(
            email="doctor3@example.com", password="password", identifier="doc789",
            user_type="practitioner"
        )
        practitioner = Practitioner.objects.get(jhe_user=practitioner_user)
...
class StudyMethodTests(TestCase):
    ...
    def test_has_patient(self):
        ...
        patient = Patient.objects.create(
            ...
            name_family="Jones", name_given="Bob", birth_date="1990-01-01", 
...
class StudyPatientScopeConsentMethodTests(TestCase):
    def setUp(self):
        ...
        self.patient = Patient.objects.create(
            ...
            name_family="Brown", name_given="Charlie", birth_date="1980-01-01", 
...
class ObservationMethodTests(TestCase):
    def setUp(self):
        ...
        self.patient = Patient.objects.create(
            jhe_user=self.user, identifier="PAT004",
            name_family="White", name_given="Daisy", birth_date="1975-07-07", 
    ...
    def test_for_practitioner_organization_study_patient(self):
        practitioner_user = JheUser.objects.create_user(
            email="doctor4@example.com", password="password", identifier="doc999",
            user_type="practitioner"
        )
        practitioner = Practitioner.objects.get(jhe_user=practitioner_user)
    ...
    def test_practitioner_authorized(self):
        practitioner_user = JheUser.objects.create_user(
            email="doctor5@example.com", password="password", identifier="doc888",
            user_type="practitioner"
        )
        practitioner = Practitioner.objects.get(jhe_user=practitioner_user)
    ...
    def test_count_for_practitioner_organization_study_patient(self):
        practitioner_user = JheUser.objects.create_user(
            email="doctor6@example.com", password="password", identifier="doc777",
            user_type="practitioner"
        )
        practitioner = Practitioner.objects.get(jhe_user=practitioner_user)
...
class PatientOrganizationTests(TestCase):
    def setUp(self):
        ...
        self.patient = Patient.objects.create(
            jhe_user=self.user, identifier="PAT005",
            name_family="Green", name_given="Edward", birth_date="1970-03-15", 
            telecom_phone="5551234567"
        )
    
    def test_create_patient_organization(self):
        po = PatientOrganization.objects.create(
            patient=self.patient,
            organization=self.org
        )
...
class PractitionerOrganizationTests(TestCase):
    def setUp(self):
        self.org = Organization.objects.create(name="Hospital", type="prov")
        self.user = JheUser.objects.create_user(
            email="doctor7@example.com", password="password", identifier="doc666",
            user_type="practitioner"
        )
        self.practitioner = Practitioner.objects.get(jhe_user=self.user)
    
    def test_create_practitioner_organization(self):
        po = PractitionerOrganization.objects.create(
            practitioner=self.practitioner,
            organization=self.org
        )
    ...
    def test_organization_users_property(self):
        ...
        patient = Patient.objects.create(
            jhe_user=patient_user, identifier="PAT006",
            name_family="Black", name_given="Frank", birth_date="1965-11-25", 
